...
public class InputDistinguisher {
     ...
     *         Utile al riconoscimento dell'input come operatore associato ad un
     *         operazione agente sullo stack.
     * 
     ...
     *         Utile al riconoscimento dell'input come operatore associato ad un
     *         operazione agente su una variabile.
     */
    public boolean isComplexNumber(String text) {
        // '*' impone l'apparizione del testo che lo precede nella matches 0 o più
        // volte.
        // '?' esplicita che il testo da cui è preceduto nella matches non debba per
        // forza essere presente nella stringa od al massimo una singola volta.
