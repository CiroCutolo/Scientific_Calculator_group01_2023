...
public class SwapOperation extends StackOperation {
    ...
    /**
     * @descrizione Il comando eseguito consente di invertire gli ultimi due
     *              elementi presenti nello stack.
     * @param stack Stack su cui si basa il funzionamento della calcolatrice.
     * @throws StackErrorException StackErrorException Lanciata se lo stack non
     *                             contiene abbastanza
     *                             abbastanza elementi per eseguire il comando.
     */

    /**
     * @descrizione Scambia di posizione gli ultimi due elementi inseriti nello
     *              stack.
     * @param stack Stack su cui si basa il funzionamento della calcolatrice.
