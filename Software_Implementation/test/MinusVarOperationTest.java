...
public class MinusVarOperationTest {
     ...
     */
    // gestisco il caso in cui è presente una variabile null nella mappa ed eseguo
    // la "-x" per controllare che l'eccezione venga lanciata.
    @Test
    ...
    // gestisco il caso in cui all'interno dello stack non ci sia un numero che
    // permette l'esecuzione della sottrazione con la variabile.
    @Test
    ...
    public void testExecute() throws Exception {
        // eseguo una serie di execute senza sollevare eccezioni e successivamente
        // confronto la parte reale del risultato atteso con la parte reale del
        // risultato
