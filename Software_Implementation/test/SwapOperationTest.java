...
public class SwapOperationTest {
    ...
    // swap per controllare che l'eccezione venga lanciata.
    @Test
    ...
    public void testExecute() throws Exception {
        // eseguo una serie di inserimenti e successivamente dopo aver eseguito la swap
        // controllo che l'ulitmo elemento e il penultimo si siano scambiati di
        // posizione.
        stack.push(number0);
        stack.push(number1);
        stack.push(number2);
