...
public class OverOperationTest {
     ...
     */
    // gestisco il caso in cui è presente un unico elemento nello stack ed eseguo
    // l'over per controllare che l'eccezione venga lanciata.
    @Test
    ...
    public void testExecute() throws Exception {
        // eseguo una serie di inserimenti e successivamente dopo aver eseguito l'over
        // controllo che l'ulitmo elemento sia uguale al penultimo elemento inserito.
        stack.push(number0);
        stack.push(number1);
        stack.push(number2);
        over.execute(stack);
